                            ...
                            <tr v-for="office in offices.data" :key="office.id" class="bg-white hover:bg-gray-50 border-b">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        <Tooltip text="Edit">
                                            <Link :href="route('office.edit', office.id)" class="w-8 h-8 flex justify-center items-center hover:bg-gray-200 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        ...
                                        <Tooltip text="Delete">
                                            <Link :href="route('office.destroy', office.id)" method="DELETE" as="button" class="w-8 h-8 flex justify-center items-center hover:bg-gray-200 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
